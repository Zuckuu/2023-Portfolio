...
const nameImgContainer = document.querySelector(".nameImageContainer");
...
window.addEventListener("scroll", () => {
  ...
  nameImgContainer.style.transform = `translate(${-444 + offsetY * 0.6}px)` ;
  ...
  con[0].style.transform = `translateX(calc(350vh - ${offsetY}px))`;
  con[1].style.transform = `translateX(calc(470vh - ${offsetY}px))`;
  con[2].style.transform = `translateX(calc(598vh - ${offsetY}px))`;
  con[3].style.transform = `translateX(calc(730vh - ${offsetY}px))`;
});
